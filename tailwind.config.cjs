  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        hero: 'linear-gradient(135deg, rgba(244,244,246,0.8) 60%, rgba(59,77,97,0.95) 60%)',
        'hero-mobile':
          'linear-gradient(137deg, rgba(244,244,246,0.8) 60%, rgba(59,77,97,1) 60%)',
        tech: "linear-gradient(165deg, rgba(59,77,97,0.8) 100%, rgba(109,109,116,0.8) 100%), url('/src/assets/backgrounds/students.jpg')",
      },
      fontFamily: {
        arenq: ['Arenq'],
        beckman: ['Beckman'],
